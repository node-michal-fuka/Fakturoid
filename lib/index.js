...
var Fakturoid = /** @class */ (function (_super) {
    ...
    Fakturoid.prototype.createInventoryMove = function (inventoryItemId, inventoryMove) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _super.prototype.post.call(this, "/inventory_items/".concat(inventoryItemId, "/inventory_moves.json"), inventoryMove)];
                    case 1: return [2 /*return*/, (_a.sent())
                            .data];
                }
            });
